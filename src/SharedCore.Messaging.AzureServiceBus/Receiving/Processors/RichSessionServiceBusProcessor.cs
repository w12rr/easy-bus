...
public class RichSessionServiceBusProcessor : IRichServiceBusProcessor
{
    private readonly ServiceBusSessionProcessor _serviceBusProcessor;
    private Func<RichServiceBusMessage, Task>? _onMessage;

    public RichSessionServiceBusProcessor(ServiceBusSessionProcessor serviceBusProcessor)
    {
    ...
    public void AttachMessageEvent(Func<RichServiceBusMessage, Task> onMessage)
    {
        ...
        _serviceBusProcessor.ProcessMessageAsync += OnProcessMessage;
    }
    ...
    private async Task OnProcessMessage(ProcessSessionMessageEventArgs arg)
    {
